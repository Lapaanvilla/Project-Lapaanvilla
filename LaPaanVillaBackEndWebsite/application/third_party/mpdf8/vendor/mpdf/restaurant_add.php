...
if($this->input->post()){
  foreach ($this->input->post() as $key => $pvalue) {
    if($key=='food_type') {
        $food_typechkarr = $this->input->post("food_type");
    } else if($key=='timings'){
        $newTimingArr=array();
        foreach($this->input->post("timings") as $key=>$value) {
                        ...
                        <div class="portlet-body form">
                            ...
                            <form action="<?php echo $form_action;?>" id="form_add<?php echo $this->prefix; ?>" name="form_add<?php echo $this->prefix; ?>" method="post" class="form-horizontal" enctype="multipart/form-data" <?php echo (Disabled_HideButton($is_masterdata,'yes')=='1')?'onsubmit="return false"':"";?>>
                                ...
                                <div class="form-body"> 
                                    ...
                                    <?php } ?>
                                    <?php if($this->session->userdata('AdminUserType') == 'BranchAdmin'){ ?>
                                    ...
                                    <?php } ?>
                                    <?php if($this->session->userdata('AdminUserType') == 'MasterAdmin' || $this->session->userdata('AdminUserType') == 'Admin'){ ?>
                                        ...
                                        <div class="form-group">   
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                $disable_res = ($enable_arr['isbranch_or_res']=='is_branch')?'disabled':''; ?>
                                                <input type="radio" <?php echo (!empty($branch_entity_id) && $branch_entity_id == '0')?'checked':'' ?> name="add_res_branch" id="radioTrue" value="res" class="add_res_branch" <?php echo $disable_res ?> <?php echo ($disable_res=='')?'checked':'' ?>  > <label for="radioTrue"><?php echo $this->lang->line('add').' '.$this->lang->line('title_admin_restaurant'); ?></label>
                                                <br>
                                                <input type="radio" <?php echo (!empty($branch_entity_id) && $branch_entity_id != '0')?'checked':'' ?>  name="add_res_branch" id="radioFalse" value="branch" class="add_res_branch" <?php echo $disable_branch ?> <?php echo ($disable_res=='disabled')?'checked':'' ?> > <label for="radioFalse"><?php echo $this->lang->line('add').' '.$this->lang->line('branch'); ?></label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group res-name" style="<?php echo (
                                        $branch_entity_id == '0' || $this->uri->segment('3') == 'add')?'display: block':'display: none'; ?>;">
                                        <label class="control-label col-md-3"><?php echo $this->lang->line('res_name') ?><span class="required">*</span></label>
                                        <div class="col-md-4">                                            
                                            <input type="text" name="res_name" id="res_name" value="<?php echo $name;?>" maxlength="249" data-required="1" class="form-control"/>
                                        </div>
                                    </div>      
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="tel" name="phone_number" id="phone_number" value="<?php echo $phone_number;?>" data-required="1" class="form-control" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <textarea class="form-control" name="about_restaurant" id="about_restaurant" maxlength="500"><?php echo $about_restaurant; ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">  
                                        ...
                                        <div class="col-sm-4">
                                            <a style="cursor:pointer;" onclick="serviceFeeOnOff()">
                                       ...
                                       <label class="control-label col-md-3"><?php echo $this->lang->line('res_time') ?></label>
                                        ...
                                        <div class="col-md-9">
                                            <table class="timingstable" width="100%" cellpadding="2" cellspacing="2">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="td-wrap">
                                                            <input type="text" class="ophrs form-control" lesserThan="#monday_close_hours" id="monday_open_hours" name="timings[monday][open]" <?php if(isset($edit_records) || !empty($edit_timingsarray)){ echo (intval(@$business_timings['monday']['off'])) ? '' : 'disabled="disabled"'; } ?> value="<?php echo @$business_timings['monday']['open']; ?>" placeholder="<?php echo $this->lang->line('opening_hours') ?>" autocomplete="off">
                                                        </div>
                                                        <div class="td-wrap">
                                                            <input type="text" class="clhrs form-control" greaterThan="#monday_open_hours" placeholder="<?php echo $this->lang->line('closing_hours') ?>" <?php if(isset($edit_records) || !empty($edit_timingsarray)){ echo (intval(@$business_timings['monday']['off'])) ? '' : 'disabled="disabled"'; } ?> value="<?php echo @$business_timings['monday']['close']; ?>" name="timings[monday][close]" id="monday_close_hours" autocomplete="off">
                                                        </div>
                                                        <div class="td-wrap">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="td-wrap">
                                                            <input type="text" class="ophrs form-control" lesserThan="#tuesday_close_hours" placeholder="<?php echo $this->lang->line('opening_hours') ?>" <?php if(isset($edit_records) || !empty($edit_timingsarray)){ echo (intval(@$business_timings['tuesday']['off'])) ? '' : 'disabled="disabled"'; } ?> value="<?php echo @$business_timings['tuesday']['open']; ?>" name="timings[tuesday][open]" id="tuesday_open_hours" autocomplete="off">
                                                        </div>
                                                        <div class="td-wrap">
                                                            <input type="text" class="clhrs form-control" greaterThan="#tuesday_open_hours" placeholder="<?php echo $this->lang->line('closing_hours') ?>" <?php if(isset($edit_records) || !empty($edit_timingsarray)){ echo (intval(@$business_timings['tuesday']['off'])) ? '' : 'disabled="disabled"'; } ?> value="<?php echo @$business_timings['tuesday']['close']; ?>" name="timings[tuesday][close]" id="tuesday_close_hours" autocomplete="off">
                                                        </div>
                                                        <div class="td-wrap">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="td-wrap">
                                                            <input type="text" class="ophrs form-control" placeholder="<?php echo $this->lang->line('opening_hours') ?>" <?php if(isset($edit_records) || !empty($edit_timingsarray)){ echo (intval(@$business_timings['friday']['off'])) ? '' : 'disabled="disabled"'; } ?> value="<?php echo @$business_timings['friday']['open']; ?>" name="timings[friday][open]" id="friday_open_hours" lesserThan="#friday_close_hours" autocomplete="off">
                                                        </div>
                                                        <div class="td-wrap">
                                                            <input type="text" class="clhrs form-control" placeholder="<?php echo $this->lang->line('closing_hours') ?>" <?php if(isset($edit_records) || !empty($edit_timingsarray)){ echo (intval(@$business_timings['friday']['off'])) ? '' : 'disabled="disabled"'; } ?> value="<?php echo @$business_timings['friday']['close']; ?>" name="timings[friday][close]" id="friday_close_hours" greaterThan="#friday_open_hours" autocomplete="off">
                                                        </div>
                                                        <div class="td-wrap">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="td-wrap">
                                                            <input type="text" class="ophrs form-control" placeholder="<?php echo $this->lang->line('opening_hours') ?>" <?php if(isset($edit_records) || !empty($edit_timingsarray)){ echo (intval(@$business_timings['saturday']['off'])) ? '' : 'disabled="disabled"'; } ?> value="<?php echo @$business_timings['saturday']['open']; ?>" name="timings[saturday][open]" id="saturday_open_hours" lesserThan="#saturday_close_hours" autocomplete="off">
                                                        </div>
                                                        <div class="td-wrap">
                                                            <input type="text" class="clhrs form-control" placeholder="<?php echo $this->lang->line('closing_hours') ?>" <?php if(isset($edit_records) || !empty($edit_timingsarray)){ echo (intval(@$business_timings['saturday']['off'])) ? '' : 'disabled="disabled"'; } ?> value="<?php echo @$business_timings['saturday']['close']; ?>" name="timings[saturday][close]" id="saturday_close_hours" greaterThan="#saturday_open_hours" autocomplete="off">
                                                        </div>
                                                        <div class="td-wrap">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="td-wrap">
                                                            <input type="text" class="ophrs form-control" placeholder="<?php echo $this->lang->line('opening_hours') ?>" <?php if(isset($edit_records) || !empty($edit_timingsarray)){ echo (intval(@$business_timings['sunday']['off'])) ? '' : 'disabled="disabled"'; } ?> value="<?php echo @$business_timings['sunday']['open']; ?>" name="timings[sunday][open]" id="sunday_open_hours" lesserThan="#sunday_close_hours" autocomplete="off">
                                                        </div>
                                                        <div class="td-wrap">
                                                            <input type="text" class="clhrs form-control" placeholder="<?php echo $this->lang->line('closing_hours') ?>" <?php if(isset($edit_records) || !empty($edit_timingsarray)){ echo (intval(@$business_timings['sunday']['off'])) ? '' : 'disabled="disabled"'; } ?> value="<?php echo @$business_timings['sunday']['close']; ?>" name="timings[sunday][close]" id="sunday_close_hours" greaterThan="#sunday_open_hours" autocomplete="off">
                                                        </div>
                                                        <div class="td-wrap">
                                        ...
                                        <div class="col-md-4">
                                            <select name="" placeholder="<?php echo $this->lang->line('select_close_days') ?>" multiple="multiple" class="form-control sumo SlectBox" id="closed_day_select">
                                                <option value="monday" <?php if(isset($edit_records) || !empty($edit_timingsarray)){ echo (intval(@$business_timings['monday']['off'])) ? '' : 'selected';} ?>><?php echo $this->lang->line('mon') ?></option>
                                                <option value="tuesday" <?php if(isset($edit_records) || !empty($edit_timingsarray)){ echo (intval(@$business_timings['tuesday']['off'])) ? '' : 'selected'; } ?>><?php echo $this->lang->line('tue') ?></option>
                                                <option value="wednesday" <?php if(isset($edit_records) || !empty($edit_timingsarray)){ echo (intval(@$business_timings['wednesday']['off'])) ? '' : 'selected'; } ?>><?php echo $this->lang->line('wed') ?></option>
                                                <option value="thursday" <?php if(isset($edit_records) || !empty($edit_timingsarray)){ echo (intval(@$business_timings['thursday']['off'])) ? '' : 'selected'; } ?>><?php echo $this->lang->line('thurs') ?></option>
                                                <option value="friday" <?php if(isset($edit_records) || !empty($edit_timingsarray)){ echo (intval(@$business_timings['friday']['off'])) ? '' : 'selected';} ?>><?php echo $this->lang->line('fri') ?></option>
                                                <option value="saturday" <?php if(isset($edit_records) || !empty($edit_timingsarray)){ echo (intval(@$business_timings['saturday']['off'])) ? '' : 'selected'; } ?>><?php echo $this->lang->line('sat') ?></option>
                                                <option value="sunday" <?php if(isset($edit_records) || !empty($edit_timingsarray)){ echo (intval(@$business_timings['sunday']['off'])) ? '' : 'selected'; } ?>><?php echo $this->lang->line('sun') ?></option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" name="contractual_commission" id="contractual_commission" value="<?php echo $contractual_commission ?>" maxlength="5" style="display: inline-block;width: 50%"/>
                                            <label>(%)</label>
                                ...
                                <div class="form-actions fluid">
                                    <div class="col-md-offset-3 col-md-9">
                                        <button type="submit" name="submit_page" <?php echo (Disabled_HideButton($is_masterdata,'yes')=='1')?"disabled":"";?>  id="submit_page" value="Submit" class="btn btn-success danger-btn"><?php echo $this->lang->line('submit') ?></button>
                                        <?php if($this->uri->segment('3')=="add") { ?>
                                            <button type="submit" name="submit_page" <?php echo (Disabled_HideButton($is_masterdata,'yes')=='1')?"disabled":"";?>  id="submit_page" value="Save" class="btn btn-success danger-btn"><?php echo $this->lang->line('save') ?></button>
                                        <?php } ?>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="radio" name="is_veg" id="is_veg" value="1" checked>&nbsp;&nbsp;<?php echo $this->lang->line('veg'); ?>&ensp;&ensp;
                            <input type="radio" name="is_veg" id="is_veg" value="0">&nbsp;&nbsp;<?php echo $this->lang->line('non_veg'); ?>
                        </div>
                        <div id="food_type_popup_error" style="padding-left: 15px;"></div>
                    </div>
                    <div class="form-actions fluid">
...
jQuery.validator.addMethod('lesserThanTableBookingCapacity', function(value, element, param) {
    ...
    return ( parseInt(value) < resultant );
