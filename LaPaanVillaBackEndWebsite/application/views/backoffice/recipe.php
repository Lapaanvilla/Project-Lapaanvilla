                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box red">
                        <div class="portlet-title">
                            <div class="caption"><?php echo $this->lang->line('recipes') ?></div>
                            <div class="actions c-dropdown"> 
                                <?php if(in_array('recipe~add',$this->session->userdata("UserAccessArray"))) { ?>
                            ...
                            <div id="delete-msg" class="alert alert-success hidden alerttimerclose">
                                ...
                                <table class="table table-striped table-bordered table-hover table-data" id="datatable_ajax">
                                        ...
                                        <tr role="row" class="filter">
                                            ...
                                            <td>
                                                <button id="search" class="btn btn-sm red filter-submit" title="<?php echo $this->lang->line('search') ?>"><i class="fa fa-search"></i></button>
        ...
        callback: function (deleteConfirm) { 
            if (deleteConfirm) {
                jQuery.ajax({
                  ...
                  dataType : "html",
                  url : 'ajaxDelete',
                  data : {'entity_id':entity_id,'content_id':content_id},
        ...
        callback: function (disableConfirm) {    
            if (disableConfirm) {
                jQuery.ajax({
                  ...
                  dataType : "json",
                  url : 'ajaxDisable',
                  data : {'entity_id':ID,'status':Status},
                  success: function(response) {
                       grid.getDataTable().fnDraw(); 
                  },
                  error: function(XMLHttpRequest, textStatus, errorThrown) {           
        ...
        callback: function (disableConfirm) {  
            if (disableConfirm) {
                jQuery.ajax({
                  ...
                  dataType : "json",
                  url : 'ajaxDisableAll',
                  data : {'content_id':ContentID,'status':Status},
                  success: function(response) {
                    grid.getDataTable().fnDraw(); 
                  },
                  error: function(XMLHttpRequest, textStatus, errorThrown) {           
