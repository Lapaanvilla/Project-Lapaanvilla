...
.div_4{text-align:center;width:20%;float:left;padding:5px 0 5px 0}
.div_5{text-align:center;width:20%;float:left;padding:5px 0 5px 0}
.div_6{text-align:left;width:30%;float:left;padding:5px 0 5px 10px;}
.b0{border-bottom: 0}
.width60{width: 60%}
.width15{width: 15%}
.width20{width: 20%}
...
<div class="pdf_main">
	...
	<div class="segment-main">
        ...
        <div class="div-thead">
          	<div>
          		<div class="div_1">#</div>
	            <div class="div_6"><?php echo $this->lang->line("user_name"); ?></div>
	            <div class="div_3"><?php echo $this->lang->line("phone_no"); ?></div>
	            <div class="div_3"><?php echo $this->lang->line("user_type"); ?></div>
	            <div class="div_4"><?php echo $this->lang->line("status"); ?></div>
            </div>
        </div>
        <!-- body -->
        <div>
        	<?php 
        	 if(!empty($report_data)){
	            ...
	            <div class="b0">
		            ...
		            <div class="div_6 center"><?php echo $value->first_name.' '.$value->last_name; ?></div>
		            <div class="div_3 center"><?php echo $value->mobile_number; ?></div>
		            <div class="div_3 center"><?php echo $value->user_type; ?></div>
		            <div class="div_4 center"><?php echo ($value->status == 1)?'Active':'Inactive'; ?></div>
	           </div>
           <?php $i++; }  } ?>
        </div>
	</div>
