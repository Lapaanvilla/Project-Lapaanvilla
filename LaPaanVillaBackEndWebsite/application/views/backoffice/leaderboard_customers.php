                            ...
                            <div class="col-md-12">    
                                ...
                                <div class="portlet box red">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <?php echo $this->lang->line('customers') ?> <?php echo $this->lang->line('list') ?>
                                        </div>
                                        <div class="actions">
                                            <?php if(in_array('leaderboard~customers_export',$this->session->userdata("UserAccessArray"))) { ?>
                                                <a class="btn danger-btn btn-sm theme-btn" id="customers_report_export"><i class="fa fa-download"></i> <?php echo $this->lang->line('export')?></a>
                                            <?php } ?>
                                        </div>
                                    </div>
                                            ...
                                            <table class="table table-striped table-bordered table-hover" id="datatable_ajax">
                                                <thead>
                                                    <tr role="row" class="heading">                                    
                                                        ...
                                                        <th><?php echo $this->lang->line('total_spend') ?></th>
                                                        <th><?php echo $this->lang->line('action') ?></th>
                                                    </tr>
                                                    <tr role="row" class="filter">
                                                        <td><input type="text" class="form-control form-filter input-sm" name="name" id="name"></td>                                
                                                        <td><!-- <input type="text" class="form-control form-filter input-sm" name="total_order" id="total_order"> --></td>                                    
                                                        <td><!-- <input type="text" class="form-control form-filter input-sm" name="total_spend" id="total_spend"> --></td>
                                                        <td>
...
jQuery(document).ready(function() {    
    ...
    grid.init({
        ...
        dataTable: {  // here you can define a typical datatable settings from http://datatables.net/usage/options 
            ...
            "sAjaxSource": "<?php echo base_url().ADMIN_URL.'/'.$this->controller_name;?>/ajaxview_customers", // ajax source
...
<!-- END JAVASCRIPTS -->
<script>
$("#customers_report_export").on("click",function(event){
    event.preventDefault();
    jQuery.ajax({
        type : "POST",
        dataType: "json",
        url:"<?php echo base_url().ADMIN_URL.'/'.$this->controller_name; ?>/customers_report_export",
        data : {'name':$("#name").val(),"total_order": $("#total_order").val(),"total_spend": $("#total_spend").val()},
