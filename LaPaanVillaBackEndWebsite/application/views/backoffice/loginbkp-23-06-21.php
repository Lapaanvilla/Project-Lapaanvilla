...
<div class="content">
    ...
    <div class="alert alert-success">
         <?php echo $this->session->flashdata('verified');?>
    </div>
    <?php } ?>
    ...
    <div class="alert alert-danger">
         <?php echo $this->session->flashdata('ErrorPreventMultiLogin');?>
    </div>
    <?php } ?>
    <?php // get Cookies
    ...
    <form id="login_form" class="login-form" action="<?php echo base_url().ADMIN_URL; ?>/home/do_login" method="post">
        ...
        <div class="form-group">
            ...
            <input type="submit" class="btn default-btn pull-right" name="submit" value="Login">
        </div>
