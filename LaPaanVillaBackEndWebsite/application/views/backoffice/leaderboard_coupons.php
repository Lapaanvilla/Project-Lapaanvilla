        ...
        <div class="page-content admin-dashboard advance--dashboard">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h3 class="page-title">
                        <?php echo $this->lang->line('coupons'); ?>
                    </h3>
                            ...
                            <div class="col-md-12">    
                                ...
                                <div class="portlet box red">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <?php echo $this->lang->line('coupons') ?> <?php echo $this->lang->line('list') ?>
                                        </div>
                                        <div class="actions">
                                            <?php if(in_array('leaderboard~coupons_export',$this->session->userdata("UserAccessArray"))) { ?>
                                                <a class="btn danger-btn btn-sm theme-btn" id="coupons_report_export"><i class="fa fa-download"></i> <?php echo $this->lang->line('export')?></a>
                                            <?php } ?>
                                        </div>
                                    </div>
                                            ...
                                            <table class="table table-striped table-bordered table-hover" id="datatable_ajax">
                                                <thead>
                                                    ...
                                                    <tr role="row" class="filter">
                                                        <td><input type="text" class="form-control form-filter input-sm" name="coupon_code" id="coupon_code"></td>                                
                                                        <td><!-- <input type="text" class="form-control form-filter input-sm" name="orders" id="orders"> --></td>                                    
                                                        <td><!-- <input type="text" class="form-control form-filter input-sm" name="discount" id="discount"> --></td>
                                                        <td>
...
jQuery(document).ready(function() {    
    ...
    grid.init({
        ...
        dataTable: {  // here you can define a typical datatable settings from http://datatables.net/usage/options 
            ...
            "sAjaxSource": "<?php echo base_url().ADMIN_URL.'/'.$this->controller_name;?>/ajaxview_coupons", // ajax source
...
<!-- END JAVASCRIPTS -->
<script>
$("#coupons_report_export").on("click",function(event){
    event.preventDefault();
    jQuery.ajax({
        type : "POST",
        dataType: "json",
        url:"<?php echo base_url().ADMIN_URL.'/'.$this->controller_name; ?>/coupons_report_export",
        data : {'coupon_code':$("#coupon_code").val(),"orders": $("#orders").val(),"discount": $("#discount").val()},
