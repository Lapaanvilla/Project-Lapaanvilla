                            ...
                            <div class="col-md-12">    
                                ...
                                <div class="portlet box red">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <?php echo $this->lang->line('products') ?> <?php echo $this->lang->line('list') ?>
                                        </div>
                                        <div class="actions">
                                            <?php if(in_array('leaderboard~products_export',$this->session->userdata("UserAccessArray"))) { ?>
                                                <a class="btn danger-btn btn-sm theme-btn" id="products_report_export"><i class="fa fa-download"></i> <?php echo $this->lang->line('export')?></a>
                                            <?php } ?>
                                        </div>
                                    </div>
...
jQuery(document).ready(function() {    
    ...
    grid.init({
        ...
        dataTable: {  // here you can define a typical datatable settings from http://datatables.net/usage/options 
            ...
            "sAjaxSource": "<?php echo base_url().ADMIN_URL.'/'.$this->controller_name;?>/ajaxview_products", // ajax source
...
<!-- END JAVASCRIPTS -->
<script>
$("#products_report_export").on("click",function(event){
    event.preventDefault();
    jQuery.ajax({
        type : "POST",
        dataType: "json",
        url:"<?php echo base_url().ADMIN_URL.'/'.$this->controller_name; ?>/products_report_export",
        data : {'name':$("#name").val(),"total_order": $("#total_order").val(),"total_amount": $("#total_amount").val()},
