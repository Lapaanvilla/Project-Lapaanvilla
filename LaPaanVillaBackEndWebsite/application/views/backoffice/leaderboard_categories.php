                            ...
                            <div class="col-md-12">    
                                ...
                                <div class="portlet box red">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <?php echo $this->lang->line('categories') ?> <?php echo $this->lang->line('list') ?>
                                        </div>
                                        <div class="actions">
                                            <?php if(in_array('leaderboard~categories_export',$this->session->userdata("UserAccessArray"))) { ?>
                                                <a class="btn danger-btn btn-sm theme-btn" id="categories_report_export"><i class="fa fa-download"></i> <?php echo $this->lang->line('export')?></a>
                                            <?php } ?>
                                        </div>
                                    </div>
...
jQuery(document).ready(function() {    
    ...
    grid.init({
        ...
        dataTable: {  // here you can define a typical datatable settings from http://datatables.net/usage/options 
            ...
            "sAjaxSource": "<?php echo base_url().ADMIN_URL.'/'.$this->controller_name;?>/ajaxview_categories", // ajax source
...
<!-- END JAVASCRIPTS -->
<script>
$("#categories_report_export").on("click",function(event){
    event.preventDefault();
    jQuery.ajax({
        type : "POST",
        dataType: "json",
        url:"<?php echo base_url().ADMIN_URL.'/'.$this->controller_name; ?>/categories_report_export",
